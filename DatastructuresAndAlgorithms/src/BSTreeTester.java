...
public class BSTreeTester {
    ...
    static BSTree BSTree = new BSTree();
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    System.out.println("Search result : " + BSTree.searchTree(scanner.nextInt()));
                    break;

                case 3:
                    //System.out.println("Nodes = " + BSTree.countNodes());
                    break;
	...
	private static void benchmark_worstCase(int numInserts) {
		...
		insert_benchmark(arr1, "csv/BS_WorstCase_0n_insert_benchmark.csv");
		search_benchmark(arr1, "csv/BS_WorstCase_0n_search_benchmark.csv");
		delete_benchmark(arr1, "csv/BS_WorstCase_0n_delete_benchmark.csv");

        insert_benchmark(arr2, "csv/BS_WorstCase_n0_insert_benchmark.csv");
		search_benchmark(arr2, "csv/BS_WorstCase_n0_search_benchmark.csv");
		delete_benchmark(arr2, "csv/BS_WorstCase_n0_delete_benchmark.csv");
	...
	private static void benchmark_average(int numInserts) {
		...
		insert_benchmark(arr, "csv/BS_average_insert_benchmark.csv");
		search_benchmark(arr, "csv/BS_average_search_benchmark.csv");
		delete_benchmark(arr, "csv/BS_average_delete_benchmark.csv");
